...
const chalk = require('chalk');
  ...
  bot.user.setActivity(".help - MoneyGen");
});
        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                ...
                const embed = {
                    ...
                    footer: {
                        icon_url:
                            "https://i.imgur.com/60AbcVe.jpg",
                        text: "Développé par Money"
                    },
                    image: {url:"https://i.imgur.com/X1QIYyS.gif"},
                    author: {
                        name: botname + " - générateur de compte",
                        url: "https://discord.gg/6pU24KegQh",
                ...
                fs.readFile(filePath, function (err, data) {
                    if (!err) {
                        ...
                        const embed = {
                            ...
                            image: {url:"https://i.imgur.com/Sq2hMY0.jpg"},
                            author: {
                                     name: botname + " - générateur de compte",
                                     url: "https://discord.gg/6pU24KegQh",
                                icon_url: bot.displayAvatarURL
